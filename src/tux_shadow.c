...
void draw_tux_shadow()
{
    ...
    glColor4f(shadow_colour.r, shadow_colour.g, shadow_colour.b, shadow_colour.a);
...
void draw_shadow_vertex(scalar_t x, scalar_t y, scalar_t z, matrixgl_t model_matrix)
{
    point_t pt;
    scalar_t old_y;
    vector_t nml;
