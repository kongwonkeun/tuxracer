...
const double ode45_error_mat[] = { 71./57600., 0., -71./16695., 71./1920., -17253./339200., 22./525., -1./40.};
...
double lin_interp( const double x[], const double y[], double val, int n )
{
    ...
    check_assertion( n>=2, "linear interpolation requires at least two data points" );
